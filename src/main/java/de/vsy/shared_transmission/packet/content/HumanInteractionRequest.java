...
/**
 * Provides basic information needed for a request and translation of requests to
 * notifications.
 */
public interface HumanInteractionRequest extends Translatable {
    ...
    /**
     * Creates a response for the current request. Setting the recipient's decision
     * and CommunicatorDTO.
     *
