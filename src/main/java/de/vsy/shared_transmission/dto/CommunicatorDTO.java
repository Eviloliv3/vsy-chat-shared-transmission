package de.vsy.shared_transmission.dto;
...
public class CommunicatorDTO implements Comparable<CommunicatorDTO>, Serializable {
   ...
   */
  private CommunicatorDTO(final int communicatorId, final String displayLabel) {
  ...
  @Override
  public int compareTo(final CommunicatorDTO otherEntity) {
  ...
  @Override
  public int hashCode() {
    return 53 * Integer.hashCode(this.communicatorId) + Objects.hashCode(this.displayLabel);
  }
  ...
  public String toString() {
    return "\"communicatorDTO\": { " + "\"communicatorId\": " + this.communicatorId
        + ", \"communicatorLabel\": "
        + this.displayLabel + " }";
  }
}
