...
import static de.vsy.shared_transmission.shared_transmission.dto.authentication.AuthenticationDTO.valueOf;

/** The Class LoginRequestDTO. */
@JsonTypeName("loginRequest")
public
class LoginRequestDTO implements PacketContent {
     ...
     */
    public
    LoginRequestDTO (final String login, final String password) {
        this(valueOf(login, password));
    }

    @JsonCreator
    public
    LoginRequestDTO (@JsonProperty("primaryData") final AuthenticationDTO authData) {
    ...
    public
    String toString () {
        var authDataString = (this.authenticationData !=
