 ...
 *
 */
package de.vsy.shared_transmission.shared_transmission.packet.content.error;
...
public
class ErrorDTO implements PacketContent, Translatable {
    ...
    @JsonCreator
    public
    ErrorDTO (@JsonProperty("errorMessage") final String errorMessage,
    ...
    String toString () {
        ...
        var originPacketString = (this.originPacket !=
                                  null) ? this.originPacket.toString() : "null";
