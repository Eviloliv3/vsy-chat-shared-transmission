...
public
class ContentIdentifierImpl implements ContentIdentifier {
    ...
    @JsonCreator
    public
    ContentIdentifierImpl (
            @JsonProperty("packetCategory") final PacketCategory packetCategory,
    ...
    public
    String toString () {
        return "\"packetCategory\": " + this.packetCategory + ", \"packetType\": " +
               this.packetType;
    }
}
