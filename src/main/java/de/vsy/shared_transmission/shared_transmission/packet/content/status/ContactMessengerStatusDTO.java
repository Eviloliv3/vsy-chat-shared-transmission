...
class ContactMessengerStatusDTO implements PacketContent {
    ...
    ContactMessengerStatusDTO (
            @JsonProperty("contactType") EligibleContactEntity contactType,
    ...
    public static
    ContactMessengerStatusDTO createFromClientStatusDTO (
    ...
    boolean equals (Object otherObject) {
        ...
        if (!(otherObject instanceof ContactMessengerStatusDTO that) ||
     ...
     */
    public
    List<TextMessageDTO> getMessages () {
    ...
    String toString () {
        ...
        sb.append("\"contactMessengerStatusDTO\": { ")
          .append("\"serviceType\": ")
        ...
        if (this.messageHistory != null && !this.messageHistory.isEmpty()) {
            ...
            this.messageHistory.forEach(
                    tTextMessage -> tTextMessageSetString.append(tTextMessage)
                                                         .append(", "));
