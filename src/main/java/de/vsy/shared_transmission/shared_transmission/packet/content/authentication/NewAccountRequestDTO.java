...
public
class NewAccountRequestDTO implements PacketContent {
    ...
    @JsonCreator
    public
    NewAccountRequestDTO (@JsonProperty("accountCreationData")
                          AccountCreationDTO accountCreationData) {
    ...
    boolean equals (Object otherObject) {
        ...
        return Objects.equals(this.accountCreationData,
                              that.getAccountCreationData());
    }

    public
    AccountCreationDTO getAccountCreationData () {
        return this.accountCreationData;
    }

    public
    void setAccountCreationData (AccountCreationDTO accountCreationData) {
        this.accountCreationData = accountCreationData;
    }
    ...
    public
    String toString () {
        var accCreationString = (this.accountCreationData !=
                                 null) ? this.accountCreationData.toString() : "null";

        return "\"accountCreationDTO\": { \"accountCreationData\": " +
               accCreationString + "}";
    }
}
