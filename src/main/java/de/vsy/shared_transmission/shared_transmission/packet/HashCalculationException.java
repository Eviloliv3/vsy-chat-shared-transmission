...
public class HashCalculationException extends RuntimeException {
  ...
  public HashCalculationException(final String errorMessage) {
    super(errorMessage);
  }

  public HashCalculationException(final Throwable baseException) {
    super(baseException);
  }

  public HashCalculationException(final String errorMessage, final Throwable baseException) {
