...
public class AccountCreationDTO implements Serializable {
  ...
  @JsonCreator
  public AccountCreationDTO(@JsonProperty("authenticationData") AuthenticationDTO authData,
  ...
  @Override
  public int hashCode() {
    return 53 * Objects.hashCode(this.authenticationData) + Objects.hashCode(
  ...
  public String toString() {
    final var authDataString =
        (this.authenticationData != null) ? this.authenticationData.toString() : "null";
    final var clientDataString =
        (this.clientPersonalData != null) ? this.clientPersonalData.toString() : "null";

    return "\"accountCreationDTO\": { \"authenticationData\": " + authDataString
        + ", \"clientData\": "
        + clientDataString + " }";
  }
}
