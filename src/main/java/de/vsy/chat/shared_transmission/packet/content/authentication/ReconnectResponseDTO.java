...
public
class ReconnectResponseDTO implements PacketContent {
    ...
    ReconnectResponseDTO (
            @JsonProperty("reconnectionState") boolean reconnectionState) {
    ...
    public
    String toString () {
        return "\"reconnectResponseDTO\": { \"reconnectionState\": " +
