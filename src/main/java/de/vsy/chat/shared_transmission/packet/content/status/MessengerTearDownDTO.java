...
public
class MessengerTearDownDTO implements PacketContent {
    ...
    MessengerTearDownDTO (
            @JsonProperty("newMessengerState") final boolean messengerState) {
    ...
    public
    String toString () {
        return super.toString() + ", \"messengerTearDownDTO\": { " +
               "\"messengerState\": " + this.newMessengerState + " }";
    }
}
