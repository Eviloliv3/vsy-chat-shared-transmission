...
public
class ReconnectRequestDTO implements PacketContent {
    ...
    @JsonCreator
    public
    ReconnectRequestDTO (@JsonProperty("clientCommunicatorData")
    ...
    public
    CommunicatorDTO getClientData () {
        return this.clientCommunicatorData;
    }

    public
    void setClientData (CommunicatorDTO clientCommunicatorData) {
        this.clientCommunicatorData = clientCommunicatorData;
    }
    ...
    public
    String toString () {
        var clientCommunicatorDataString = (this.clientCommunicatorData !=
                                            null) ? this.clientCommunicatorData.toString() : "null";
        return "\"reconnectRequestDTO\": { \"clientCommunicatorData\": " +
               clientCommunicatorDataString + "}";
    }
}
