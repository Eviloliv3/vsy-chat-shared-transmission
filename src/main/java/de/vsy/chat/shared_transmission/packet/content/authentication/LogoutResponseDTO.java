...
public
class LogoutResponseDTO implements PacketContent {
    ...
    @JsonCreator
    public
    LogoutResponseDTO (@JsonProperty("primaryData") final boolean logoutState) {
    ...
    public
    boolean getLogoutState () {
        return this.logoutState;
    }

    public
    void setLogoutState (boolean logoutState) {
        this.logoutState = logoutState;
    }
