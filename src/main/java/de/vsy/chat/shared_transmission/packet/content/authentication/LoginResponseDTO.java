...
public
class LoginResponseDTO implements PacketContent {
    ...
    @JsonCreator
    public
    LoginResponseDTO (@JsonProperty("clientData") final CommunicatorDTO clientData) {
    ...
    public
    String toString () {
        var clientDataString = (this.clientCommunicatorData !=
