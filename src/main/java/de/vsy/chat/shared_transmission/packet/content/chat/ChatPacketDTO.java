 ...
 *
 */
package de.vsy.chat.shared_transmission.packet.content.chat;
...
@JsonTypeInfo(use = NAME,
              property = "type")
@JsonSubTypes({@Type(value = TextMessageDTO.class,
                     name = "message")})
@JsonTypeName("chatPacketData")
public abstract
class ChatPacketDTO<T extends Serializable> implements PacketContent {
    ...
    @JsonCreator
    protected
    ChatPacketDTO (@JsonProperty("originatorId") final int originatorId,
     ...
     */
    public
    void setOriginatorId (final int originatorId) {
        this.originatorId = originatorId;
    }
    ...
    String toString () {
        ...
        return "\"chatPacketDTO\": { \"message\": \"" + messageString + "\", " +
               "\"originatorId\": " + this.originatorId + ", \"contactType\": " +
               this.contactType + ", \"recipientId\": " + this.recipientId + " }";
    }
