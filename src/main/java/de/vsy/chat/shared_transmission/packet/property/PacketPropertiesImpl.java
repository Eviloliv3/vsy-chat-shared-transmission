...
class PacketPropertiesImpl implements PacketProperties {
    ...
    @JsonCreator
    public
    PacketPropertiesImpl (
            @JsonProperty("sender") final CommunicationEndpoint senderEntity,
            @JsonProperty("recipient") final CommunicationEndpoint recipientEntity,
            @JsonProperty("packetIdentificationProvider")
    ...
    String toString () {
        ...
        final var senderIdString = (this.sender !=
                                    null) ? this.sender.toString() : null;
        final var recipientIdString = (this.recipient !=
                                       null) ? this.recipient.toString() : null;
        final var identifierString = (this.identifier !=
                                      null) ? this.identifier.toString() : null;
        sb.append("{ \"senderEntity\": {")
          .append(senderIdString)
          .append("}, \"recipientEntity\": {")
          .append(recipientIdString)
          .append("}, \"PacketIdentifier\": {")
