 ...
 *
 */
package de.vsy.chat.shared_transmission.packet.content.relation;

import com.fasterxml.jackson.annotation.JsonCreator;
import com.fasterxml.jackson.annotation.JsonProperty;
import com.fasterxml.jackson.annotation.JsonTypeName;
import de.vsy.chat.shared_transmission.dto.CommunicatorDTO;
import de.vsy.chat.shared_transmission.packet.content.HumanInteractionRequest;
...
public
class ContactRelationRequestDTO implements HumanInteractionRequest {
    ...
    ContactRelationRequestDTO (
            ...
            final CommunicatorDTO requestingClient,
    ...
    boolean equals (Object otherObject) {
        ...
        return this.contactType == that.getContactType() &&
    ...
    String toString () {
        ...
        final var requestingClientDataString = (this.requestingClient !=
                                                null) ? this.requestingClient.toString() : null;
        sb.append("\"contactRelationRequest\": { ")
          .append(", \"originatorId\": ")
          .append(this.originatorId)
          .append(", \"recipientId\": ")
          .append(this.recipientId)
          .append(", \"desiredState\": ")
          .append(this.desiredState)
